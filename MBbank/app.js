(function (e) {
  ...
  e(document).ready(function () {
    e(".app-sidebar a").each(function () {
      ...
      this.href == t &&
        ...
        e(this).parent().parent().prev().click());
    });
  }),
    e(document).ready(function () {
    ...
    e(".cover-image").each(function () {
      ...
      void 0 !== t &&
        !1 !== t &&
        e(this).css("background", "url(" + t + ") center center");
    }),
  ...
  e(".admin-navbar .nav li a").each(function () {
    ...
    (n = e(this)),
      t &&
        -1 !== n.attr("href").indexOf(t) &&
        (n.parents(".admin-navbar .nav-item").last().addClass("active"),
        n.parents(".admin-navbar .nav-sub").length &&
          n.parents(".admin-navbar .sub-item ul li").last().addClass("active"));
  });
  const n = "div.card";
  e('[data-toggle="tooltip"]').tooltip(),
    ...
    e('[data-toggle="card-collapse"]').on("click", function (t) {
      return (
        e(this).closest(n).toggleClass("card-collapsed"), t.preventDefault(), !1
      );
    }),
    ...
    e(".scroll-to").click(function (t) {
      ...
      e("li.nav-item.with-sub.active").removeClass("active"),
        e(this).parent().addClass("active"),
        e("html, body").animate({ scrollTop: e(n).offset().top - 30 }, 500);
    });
})(jQuery);
