...
!(function (global, factory) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(factory)
    : ((global =
        "undefined" != typeof globalThis ? globalThis : global || self).io =
        factory());
})(this, function () {
  "use strict";
  ...
  function _construct(Parent, args, Class) {
    return (_construct = _isNativeReflectConstruct()
      ...
      : function _construct(Parent, args, Class) {
          ...
          a.push.apply(a, args);
          var Constructor,
            instance = new (Function.bind.apply(Parent, a))();
  ...
  for (
    var ERROR_PACKET = { type: "error", data: "parser error" },
      ...
      isView$1 = function isView(obj) {
        return "function" == typeof ArrayBuffer.isView
          ? ArrayBuffer.isView(obj)
          : obj && obj.buffer instanceof ArrayBuffer;
      },
      encodePacket = function encodePacket(_ref, supportsBinary, callback) {
        var type = _ref.type,
          data = _ref.data;
        return withNativeBlob$1 && data instanceof Blob
          ? supportsBinary
            ? callback(data)
      ...
      encodeBlobAsBase64 = function encodeBlobAsBase64(data, callback) {
      ...
      lookup$1 = "undefined" == typeof Uint8Array ? [] : new Uint8Array(256),
      i$1 = 0;
    i$1 < chars.length;
    i$1++
  )
  ...
  var decode$1 = function decode(base64) {
      var bufferLength = 0.75 * base64.length,
        len = base64.length,
        i,
        p = 0,
        encoded1,
      ...
      "=" === base64[base64.length - 1] &&
        (bufferLength--, "=" === base64[base64.length - 2] && bufferLength--);
    ...
    decodePacket = function decodePacket(encodedPacket, binaryType) {
      if ("string" != typeof encodedPacket)
      ...
      return "b" === type
        ...
        : PACKET_TYPES_REVERSE[type]
        ? encodedPacket.length > 1
          ? {
    ...
    decodeBase64Packet = function decodeBase64Packet(data, binaryType) {
      if (withNativeArrayBuffer$1) {
        var decoded = decode$1(data);
        return mapBinary(decoded, binaryType);
      }
      return { base64: !0, data: data };
    },
    mapBinary = function mapBinary(data, binaryType) {
      switch (binaryType) {
        case "blob":
    ...
    encodePayload = function encodePayload(packets, callback) {
      var length = packets.length,
        encodedPackets = new Array(length),
        count = 0;
      packets.forEach(function (packet, i) {
        encodePacket(packet, !1, function (encodedPacket) {
          (encodedPackets[i] = encodedPacket),
            ++count === length && callback(encodedPackets.join(SEPARATOR));
        });
      });
    },
    decodePayload = function decodePayload(encodedPayload, binaryType) {
      for (
        ...
        if ((packets.push(decodedPacket), "error" === decodedPacket.type))
          break;
      }
      return packets;
    },
    ...
    (Emitter.prototype.off =
      ...
      Emitter.prototype.removeEventListener =
        function (event, fn) {
          ...
          return (
            0 === callbacks.length && delete this._callbacks["$" + event], this
          );
        }),
  ...
  function pick(obj) {
    ...
    return attr.reduce(function (acc, k) {
      return obj.hasOwnProperty(k) && (acc[k] = obj[k]), acc;
    }, {});
  }
  ...
  function byteLength(obj) {
    return "string" == typeof obj
      ? utf8Length(obj)
      : Math.ceil(1.33 * (obj.byteLength || obj.size));
  }
  function utf8Length(str) {
    for (var c = 0, length = 0, i = 0, l = str.length; i < l; i++)
  ...
  var TransportError = (function (_Error) {
      ...
      function TransportError(reason, description, context) {
        ...
        return (
          ...
          ((_this = _super.call(this, reason)).description = description),
    ...
    Transport = (function (_Emitter) {
      ...
      function Transport(opts) {
        ...
        return (
          ...
          ((_this2 = _super2.call(this)).writable = !1),
  ...
  function decode(qs) {
    for (
      var qry = {}, pairs = qs.split("&"), i = 0, l = pairs.length;
      i < l;
      i++
    ) {
  ...
  function empty() {}
  var hasXHR2 = null != new XHR({ xdomain: !1 }).responseType,
    xhr,
    Polling = (function (_Transport) {
      ...
      function Polling(opts) {
        ...
        if (
          ...
          ((_this = _super.call(this, opts)).polling = !1),
        ...
        return (_this.supportsBinary = hasXHR2 && !forceBase64), _this;
      }
      return (
        _createClass(Polling, [
          ...
          },
          {
            ...
            value: function pause(onPause) {
              ...
              var pause = function pause() {
                (_this2.readyState = "paused"), onPause();
              };
          ...
          },
          {
            ...
            value: function onData(data) {
              var _this3 = this,
                callback = function callback(packet) {
                  if (
              ...
              (this.writable = !1),
                encodePayload(packets, function (data) {
                  _this5.doWrite(data, function () {
                    (_this5.writable = !0), _this5.emitReserved("drain");
                  });
                });
            },
          },
          {
            ...
            value: function uri() {
              ...
              !1 !== this.opts.timestampRequests &&
                ...
                this.opts.port &&
                  (("https" === schema && 443 !== Number(this.opts.port)) ||
                    ("http" === schema && 80 !== Number(this.opts.port))) &&
                  (port = ":" + this.opts.port);
            ...
            value: function request() {
              var opts =
                arguments.length > 0 && void 0 !== arguments[0]
                  ...
                  : {};
              return (
                _extends(opts, { xd: this.xd, xs: this.xs }, this.opts),
                new Request(this.uri(), opts)
              );
            },
          },
          {
            ...
            value: function doWrite(data, fn) {
              var _this6 = this,
                req = this.request({ method: "POST", data: data });
              req.on("success", fn),
      ...
      function Request(uri, opts) {
        ...
        return (
          ...
          installTimerFunctions(
            _assertThisInitialized((_this8 = _super2.call(this))),
            opts
          ),
          (_this8.opts = opts),
          (_this8.method = opts.method || "GET"),
          (_this8.uri = uri),
          (_this8.async = !1 !== opts.async),
              ...
              try {
                ...
                try {
                  if (this.opts.extraHeaders)
                    for (var i in (xhr.setDisableHeaderCheck &&
                    ...
                    4 === xhr.readyState &&
                      (200 === xhr.status || 1223 === xhr.status
                        ...
                        : _this9.setTimeoutFn(function () {
                            _this9.onError(
                              "number" == typeof xhr.status ? xhr.status : 0
                            );
                          }, 0));
                  }),
                  xhr.send(this.data);
      ...
      websocket: (function (_Transport) {
        ...
        function WS(opts) {
          ...
          return (
            ...
            ((_this = _super.call(this, opts)).supportsBinary =
              !opts.forceBase64),
            _this
          );
        }
            ...
            },
            {
              ...
              value: function addEventListeners() {
                ...
                (this.ws.onopen = function () {
                  _this2.opts.autoUnref && _this2.ws._socket.unref(),
                    _this2.onOpen();
                }),
            ...
            },
            {
              ...
              value: function uri() {
                var query = this.query || {},
                  ...
                  port = "";
                this.opts.port &&
                  (("wss" === schema && 443 !== Number(this.opts.port)) ||
                    ("ws" === schema && 80 !== Number(this.opts.port))) &&
                  (port = ":" + this.opts.port),
  ...
  var Socket$1 = (function (_Emitter) {
    ...
    function Socket(uri) {
      ...
      return (
        ...
        uri && "object" === _typeof(uri) && ((opts = uri), (uri = null)),
        uri
          ? ((uri = parse(uri)),
          ...
          : opts.host && (opts.hostname = parse(opts.host).host),
        ...
        "string" == typeof _this.opts.query &&
        ...
        "function" == typeof addEventListener &&
          (_this.opts.closeOnBeforeunload &&
            ((_this.beforeunloadEventListener = function () {
              _this.transport &&
                (_this.transport.removeAllListeners(), _this.transport.close());
            }),
            addEventListener(
              "beforeunload",
          ...
          "localhost" !== _this.hostname &&
            ((_this.offlineEventListener = function () {
              _this.onClose("transport close", {
                description: "network connection lost",
              });
            }),
            addEventListener("offline", _this.offlineEventListener, !1))),
        _this.open(),
        _this
      );
    }
      ...
      _createClass(Socket, [
        ...
        },
        {
          ...
          value: function getWritablePackets() {
            ...
            for (var payloadSize = 1, i = 0; i < this.writeBuffer.length; i++) {
              var data = this.writeBuffer[i].data;
              if (
                (data && (payloadSize += byteLength(data)),
                i > 0 && payloadSize > this.maxPayload)
              )
        ...
        },
        {
          ...
          value: function sendPacket(type, data, options, fn) {
            if (
              ("function" == typeof data && ((fn = data), (data = void 0)),
        ...
        },
        {
          ...
          value: function close() {
            var _this6 = this,
              close = function close() {
                _this6.onClose("forced close"), _this6.transport.close();
              },
              cleanupAndClose = function cleanupAndClose() {
                _this6.off("upgrade", cleanupAndClose),
                  _this6.off("upgradeError", cleanupAndClose),
                  close();
              },
              waitForUpgrade = function waitForUpgrade() {
            ...
            return (
              ("opening" !== this.readyState && "open" !== this.readyState) ||
                ...
                this.writeBuffer.length
                  ? this.once("drain", function () {
                      _this6.upgrading ? waitForUpgrade() : close();
                    })
                  : this.upgrading
                  ? waitForUpgrade()
                  : close()),
        ...
        },
        {
          ...
          value: function filterUpgrades(upgrades) {
            for (
              var filteredUpgrades = [], i = 0, j = upgrades.length;
              i < j;
              i++
            )
              ~this.transports.indexOf(upgrades[i]) &&
  ...
  function url(uri) {
    var path =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "",
      loc = arguments.length > 2 ? arguments[2] : void 0,
      obj = uri;
    (loc = loc || ("undefined" != typeof location && location)),
      ...
      "string" == typeof uri &&
        ...
        (obj = parse(uri))),
      obj.port ||
        (/^(http|ws)$/.test(obj.protocol)
          ? (obj.port = "80")
          : /^(http|ws)s$/.test(obj.protocol) && (obj.port = "443")),
      (obj.path = obj.path || "/");
  ...
  (Socket$1.protocol = 4), Socket$1.protocol;
  var withNativeArrayBuffer = "function" == typeof ArrayBuffer,
    ...
    withNativeBlob =
      "function" == typeof Blob ||
      ("undefined" != typeof Blob &&
        "[object BlobConstructor]" === toString.call(Blob)),
    withNativeFile =
      "function" == typeof File ||
      ("undefined" != typeof File &&
        "[object FileConstructor]" === toString.call(File));
  ...
  function _deconstructPacket(data, buffers) {
    ...
    if ("object" === _typeof(data) && !(data instanceof Date)) {
      var _newData = {};
      for (var key in data)
  ...
  var Encoder = (function () {
      function Encoder(replacer) {
        _classCallCheck(this, Encoder), (this.replacer = replacer);
      }
      return (
        _createClass(Encoder, [
          {
            ...
            value: function encode(obj) {
              return (obj.type !== PacketType.EVENT &&
    ...
    Decoder = (function (_Emitter) {
      ...
      function Decoder(reviver) {
        ...
        return (
          ...
          ((_this = _super.call(this)).reviver = reviver),
          _this
        );
      }
      return (
          ...
          [
            {
              ...
              value: function add(obj) {
                ...
                if ("string" == typeof obj)
                  (packet = this.decodeString(obj)).type ===
                    PacketType.BINARY_EVENT ||
                  packet.type === PacketType.BINARY_ACK
                    ? ((this.reconstructor = new BinaryReconstructor(packet)),
                      0 === packet.attachments &&
                        _get(
  ...
  var RESERVED_EVENTS = Object.freeze({
    ...
    Socket = (function (_Emitter) {
      ...
      function Socket(io, nsp, opts) {
        ...
        return (
          _classCallCheck(this, Socket),
          ((_this = _super.call(this)).connected = !1),
          (_this.receiveBuffer = []),
          (_this.sendBuffer = []),
          (_this.ids = 0),
          (_this.acks = {}),
          ...
          (_this.io = io),
          (_this.nsp = nsp),
          opts && opts.auth && (_this.auth = opts.auth),
          _this.io._autoConnect && _this.open(),
          _this
        );
      }
      return (
        _createClass(Socket, [
          ...
          },
          {
            ...
            value: function emit(ev) {
              ...
              args.unshift(ev);
              var packet = { type: PacketType.EVENT, data: args, options: {} };
              if (
                ((packet.options.compress = !1 !== this.flags.compress),
          ...
          },
          {
            ...
            value: function _registerAckCallback(id, ack) {
              ...
              } else this.acks[id] = ack;
            },
          },
          {
            key: "packet",
            value: function packet(_packet) {
              (_packet.nsp = this.nsp), this.io._packet(_packet);
            },
          },
          {
            key: "onopen",
            value: function onopen() {
              ...
              "function" == typeof this.auth
                ? this.auth(function (data) {
                    _this3.packet({ type: PacketType.CONNECT, data: data });
                  })
          ...
          },
          {
            ...
            value: function onevent(packet) {
              ...
              null != packet.id && args.push(this.ack(packet.id)),
                this.connected
                  ? this.emitEvent(args)
            ...
            value: function emitBuffered() {
              ...
              this.receiveBuffer.forEach(function (args) {
                ...
                this.sendBuffer.forEach(function (packet) {
                  _this4.notifyOutgoingListeners(packet), _this4.packet(packet);
                }),
                (this.sendBuffer = []);
            },
          },
          ...
          },
          {
            ...
            value: function compress(_compress) {
              return (this.flags.compress = _compress), this;
            },
          },
          {
            key: "volatile",
          ...
          },
          {
            ...
            value: function timeout(_timeout) {
              return (this.flags.timeout = _timeout), this;
            },
          },
          {
            key: "onAny",
          ...
          },
          {
            ...
            value: function offAny(listener) {
              ...
              if (listener) {
                for (
                  var listeners = this._anyListeners, i = 0;
                  i < listeners.length;
                  i++
                )
          ...
          },
          {
            ...
            value: function offAnyOutgoing(listener) {
              ...
              if (listener) {
                for (
                  var listeners = this._anyOutgoingListeners, i = 0;
                  i < listeners.length;
                  i++
                )
                  if (listener === listeners[i])
              ...
              if (
                ...
                try {
                  for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                    var listener;
                    _step2.value.apply(this, packet.data);
                  }
                } catch (err) {
                  _iterator2.e(err);
                } finally {
  ...
  var Manager = (function (_Emitter) {
      ...
      function Manager(uri, opts) {
        ...
        _classCallCheck(this, Manager),
          ((_this = _super.call(this)).nsps = {}),
          (_this.subs = []),
          uri && "object" === _typeof(uri) && ((opts = uri), (uri = void 0)),
          ((opts = opts || {}).path = opts.path || "/socket.io"),
          (_this.opts = opts),
          installTimerFunctions(_assertThisInitialized(_this), opts),
          _this.reconnection(!1 !== opts.reconnection),
          _this.reconnectionAttempts(opts.reconnectionAttempts || 1 / 0),
          ...
          _this.randomizationFactor(
            null !== (_a = opts.randomizationFactor) && void 0 !== _a ? _a : 0.5
          ),
        ...
        return (
          ...
          (_this._autoConnect = !1 !== opts.autoConnect),
          _this._autoConnect && _this.open(),
          _this
        );
      }
      return (
        _createClass(Manager, [
            ...
            value: function reconnectionDelay(v) {
              ...
              return void 0 === v
                ...
                : ((this._reconnectionDelay = v),
                  null === (_a = this.backoff) || void 0 === _a || _a.setMin(v),
                  this);
            },
          },
          {
            ...
            value: function reconnectionDelayMax(v) {
              ...
              return void 0 === v
                ...
                : ((this._reconnectionDelayMax = v),
                  null === (_a = this.backoff) || void 0 === _a || _a.setMax(v),
                  this);
            },
          },
          {
          ...
          },
          {
            ...
            value: function open(fn) {
              ...
              var openSubDestroy = on(socket, "open", function () {
                ...
                errorSub = on(socket, "error", function (err) {
                  self.cleanup(),
              ...
              return (
                this.subs.push(openSubDestroy), this.subs.push(errorSub), this
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function _destroy(socket) {
              for (
                var nsps, _i = 0, _nsps = Object.keys(this.nsps);
                _i < _nsps.length;
                _i++
              ) {
                var nsp = _nsps[_i],
          ...
          },
          {
            ...
            value: function _packet(packet) {
              for (
                var encodedPackets = this.encoder.encode(packet), i = 0;
                i < encodedPackets.length;
                i++
              )
  ...
  function lookup(uri, opts) {
    "object" === _typeof(uri) && ((opts = uri), (uri = void 0));
    var parsed = url(uri, (opts = opts || {}).path || "/socket.io"),
