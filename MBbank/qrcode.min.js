  ...
  })()(
    {
      ...
      5: [
        function (t, r, e) {
          function n(t) {
            ...
            (this.size = t),
              (this.data = o.alloc(t * t)),
              (this.reservedBit = o.alloc(t * t));
          }
        ...
        function (t, r, e) {
          ...
          (e.isValid = function (t) {
            ...
            (e.getPenaltyN1 = function (t) {
              for (
                var r = t.size, e = 0, n = 0, i = 0, u = null, a = null, f = 0;
                f < r;
                f++
              ) {
                (n = i = 0), (u = a = null);
                for (var s = 0; s < r; s++) {
                  ...
                  h === u
                    ? n++
                    : (n >= 5 && (e += o.N1 + (n - 5)), (u = h), (n = 1)),
                    (h = t.get(s, f)),
                    h === a
                      ? i++
                      : (i >= 5 && (e += o.N1 + (i - 5)), (a = h), (i = 1));
                }
                n >= 5 && (e += o.N1 + (n - 5)),
                  i >= 5 && (e += o.N1 + (i - 5));
              }
            ...
            (e.applyMask = function (t, r) {
              for (var e = r.size, o = 0; o < e; o++)
                for (var i = 0; i < e; i++)
                  r.isReserved(i, o) || r.xor(i, o, n(t, i, o));
            }),
            (e.getBestMask = function (t, r) {
              for (
                var n = Object.keys(e.Patterns).length, o = 0, i = 1 / 0, u = 0;
                u < n;
                u++
              ) {
                r(u), e.applyMask(u, t);
      ...
      16: [
        function (t, r, e) {
          ...
          (e.mul = function (t, r) {
            for (
              var e = n.alloc(t.length + r.length - 1), i = 0;
              i < t.length;
              i++
            )
              for (var u = 0; u < r.length; u++) e[i + u] ^= o.mul(t[i], r[u]);
            return e;
          }),
            (e.mod = function (t, r) {
              for (var e = n.from(t); e.length - r.length >= 0; ) {
                for (var i = e[0], u = 0; u < r.length; u++)
                  e[u] ^= o.mul(r[u], i);
      ...
      17: [
        function (t, r, e) {
          function n(t, r) {
            for (
              var e = t.size, n = w.getPositions(r), o = 0;
              o < n.length;
              o++
            )
          ...
          function u(t, r) {
            for (
              var e, n, o, i = t.size, u = A.getEncodedBits(r), a = 0;
              a < 18;
              a++
            )
              (e = Math.floor(a / 3)),
          ...
          function f(t, r) {
            for (
              var e = t.size, n = -1, o = e - 1, i = 7, u = 0, a = e - 1;
              a > 0;
              a -= 2
            )
              for (6 === a && a--; ; ) {
          ...
          function s(t, r, e) {
            ...
            e.forEach(function (r) {
              n.put(r.mode.bit, 4),
                n.put(r.getLength(), T.getCharCountIndicator(r.mode, t)),
                r.write(n);
            });
            ...
            for (
              ...
              n.putBit(0);
            for (var a = (u - n.getLengthInBits()) / 8, f = 0; f < a; f++)
              n.put(f % 2 ? 17 : 236, 8);
            return h(n, t, r);
          }
          function h(t, r, e) {
            ...
            var R,
              ...
              I = 0;
            for (R = 0; R < m; R++)
              for (C = 0; C < u; C++) R < v[C].length && (P[I++] = v[C][R]);
          ...
          e.create = function (t, r) {
            ...
            return (
              void 0 !== r &&
                ((o = p.from(r.errorCorrectionLevel, p.M)),
                (e = A.from(r.version)),
                (n = m.from(r.maskPattern)),
                r.toSJISFunc && g.setToSJISFunction(r.toSJISFunc)),
              c(t, e, o, n)
            );
          };
        },
      ...
      20: [
        function (t, r, e) {
          ...
          function i(t) {
            ...
            return (
              v.isKanjiModeEnabled()
                ? ((r = o(y.BYTE, c.BYTE, t)), (e = o(y.KANJI, c.KANJI, t)))
                : ((r = o(y.BYTE_KANJI, c.BYTE, t)), (e = [])),
              n
                .concat(i, r, e)
                .sort(function (t, r) {
            ...
            for (var r = [], e = 0; e < t.length; e++) {
              ...
              switch (o.mode) {
                case c.NUMERIC:
                  r.push([
                    o,
                    { data: o.data, mode: c.ALPHANUMERIC, length: o.length },
                ...
                case c.KANJI:
                  r.push([
                    o,
                    { data: o.data, mode: c.BYTE, length: n(o.data) },
                  ]);
                  break;
                case c.BYTE:
              ...
              for (var a = t[i], f = [], s = 0; s < a.length; s++) {
                ...
                for (var g = 0; g < o.length; g++) {
                  ...
                  e[p] && e[p].node.mode === h.mode
                    ? ((n[p][l] =
                        u(e[p].lastCount + h.length, h.mode) -
                        u(e[p].lastCount, h.mode)),
                      (e[p].lastCount += h.length))
                    : (e[p] && (e[p].lastCount = h.length),
                      (n[p][l] =
                        u(h.length, h.mode) +
                        4 +
                        c.getCharCountIndicator(h.mode, r)));
                }
              }
              o = f;
            }
          ...
          function h(t, r) {
            ...
            switch (
              (e !== c.KANJI || v.isKanjiModeEnabled() || (e = c.BYTE), e)
            ) {
              case c.NUMERIC:
                return new l(t);
              case c.ALPHANUMERIC:
          ...
          (e.fromArray = function (t) {
            ...
            (e.fromString = function (t, r) {
              for (
                var n = i(t, v.isKanjiModeEnabled()),
                  o = f(n),
                  u = s(o, r),
                  h = w.find_path(u.map, "start", "end"),
                  c = [],
                  l = 1;
                l < h.length - 1;
                l++
        ...
        function (t, r, e) {
          ...
          (e.from = function (t, r) {
            ...
            (e.getEncodedBits = function (t) {
              ...
              for (var r = t << 12; a.getBCHDigit(r) - g >= 0; )
                r ^= 7973 << (a.getBCHDigit(r) - g);
              return (t << 12) | r;
            });
        },
        {
          ...
          function n(t, r, e, n, u) {
            ...
            if (!s) {
              ...
              return (
                1 === f
                  ? ((e = r), (r = n = void 0))
                  : 2 !== f || r.getContext || ((n = e), (e = r), (r = void 0)),
            ...
            2 === f
              ? ((u = e), (e = r), (r = n = void 0))
              : 3 === f &&
                (r.getContext && void 0 === u
                  ? ((u = n), (n = void 0))
                  : ((u = n), (n = e), (e = r), (r = void 0)));
            try {
              var h = i.create(e, n);
              u(null, t(h, r, n));
            } catch (t) {
      ...
      25: [
        function (t, r, e) {
          ...
          (e.render = function (t, r, e) {
            var u = e,
              a = r;
            void 0 !== u || (r && r.getContext) || ((u = r), (r = void 0)),
              r || (a = o()),
              (u = i.getOptions(u));
      ...
      28: [
        function (t, r, e) {
          ...
          function u(t, r) {
            ...
            return (
              n.TYPED_ARRAY_SUPPORT
                ? ((e = new Uint8Array(r)), (e.__proto__ = n.prototype))
                : ((e = t), null === e && (e = new n(r)), (e.length = r)),
              e
            );
          }
          function a(t, r) {
          ...
          function s(t, r) {
            for (
              var e = r.length < 0 ? 0 : 0 | o(r.length), n = u(t, e), i = 0;
              i < e;
              i += 1
            )
              n[i] = 255 & r[i];
          ...
          function c(t, r) {
            ...
            if (r) {
              if (
                ...
                return "number" != typeof r.length || i(r.length)
                  ? u(t, 0)
                  : s(t, r);
          ...
          n.TYPED_ARRAY_SUPPORT &&
            ...
            (n.prototype.copy = function (t, r, e, o) {
              ...
              o > this.length && (o = this.length),
                t.length - r < o - e && (o = t.length - r + e);
              var i,
                u = o - e;
              if (this === t && e < r && r < o)
                for (i = u - 1; i >= 0; --i) t[i + r] = this[i + e];
              else if (u < 1e3 || !n.TYPED_ARRAY_SUPPORT)
        ...
        function (t, r, e) {
          ...
          function u(t) {
            ...
            return (
              2 === a &&
                ((r =
                  (c[t.charCodeAt(e)] << 2) | (c[t.charCodeAt(e + 1)] >> 4)),
                (f[s++] = 255 & r)),
              1 === a &&
                ((r =
                  (c[t.charCodeAt(e)] << 10) |
          ...
          function s(t) {
            for (
              var r, e = t.length, n = e % 3, o = [], i = 0, u = e - n;
              i < u;
              i += 16383
            )
      ...
      30: [
        function (t, r, e) {
          ...
          function h(t) {
            for (
              var r = t.length < 0 ? 0 : 0 | g(t.length), e = n(r), o = 0;
              o < r;
              o += 1
            )
              e[o] = 255 & t[o];
          ...
          function w(t, r, e, n, i) {
            ...
            if (("string" == typeof r && (r = o.from(r, n)), o.isBuffer(r)))
              return 0 === r.length ? -1 : m(t, r, e, n, i);
            if ("number" == typeof r)
              return (
                (r &= 255),
          ...
          function k(t, r, e, n, o) {
            return (
              (r = +r),
              (e >>>= 0),
              o || _(t, r, e, 4, 3.4028234663852886e38, -3.4028234663852886e38),
              V.write(t, r, e, n, 23, 4),
              e + 4
            );
          }
          function O(t, r, e, n, o) {
            return (
              ...
              (e >>>= 0),
              o ||
                _(t, r, e, 8, 1.7976931348623157e308, -1.7976931348623157e308),
              V.write(t, r, e, n, 52, 8),
              e + 8
            );
          }
          function Y(t) {
          ...
          (e.kMaxLength = $),
            ...
            (o.compare = function (t, r) {
              if (
                ...
                J(r, Uint8Array) && (r = o.from(r, r.offset, r.byteLength)),
                !o.isBuffer(t) || !o.isBuffer(r))
              )
                throw new TypeError(
            ...
            (o.concat = function (t, r) {
              ...
              for (e = 0; e < t.length; ++e) {
                var u = t[e];
                if ((J(u, Uint8Array) && (u = o.from(u)), !o.isBuffer(u)))
                  throw new TypeError(
                    '"list" argument must be an Array of Buffers'
                  );
          ...
          (o.prototype.slice = function (t, r) {
            ...
            (o.prototype.writeIntLE = function (t, r, e, n) {
              ...
              for (this[r] = 255 & t; ++i < e && (u *= 256); )
                t < 0 && 0 === a && 0 !== this[r + i - 1] && (a = 1),
                  (this[r + i] = (((t / u) >> 0) - a) & 255);
              return r + e;
            }),
            ...
            (o.prototype.copy = function (t, r, e, n) {
              ...
              if (
                ...
                for (var u = i - 1; u >= 0; --u) t[u + r] = this[u + e];
          ...
          var n = {
            ...
            PriorityQueue: {
              make: function (t) {
                ...
                return (
                  (o.queue = []), (o.sorter = t.sorter || e.default_sorter), o
                );
              },
        ...
        function (t, r, e) {
          (e.read = function (t, r, e, n, o) {
            var i,
              ...
              g = t[r + c];
            for (
              c += l, i = g & ((1 << -h) - 1), g >>= -h, h += a;
              h > 0;
              i = 256 * i + t[r + c], c += l, h -= 8
            );
            for (
              u = i & ((1 << -h) - 1), i >>= -h, h += n;
              h > 0;
                  ...
                  isNaN(r) || r === 1 / 0
                    ...
                    : ((u = Math.floor(Math.log(r) / Math.LN2)),
                      ...
                      u + c >= h
                        ? ((a = 0), (u = h))
                        : u + c >= 1
                        ? ((a = (r * f - 1) * Math.pow(2, o)), (u += c))
                        : ((a = r * Math.pow(2, c - 1) * Math.pow(2, o)),
                          (u = 0)));
                o >= 8;
